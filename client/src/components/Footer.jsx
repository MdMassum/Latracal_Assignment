...
function Footer() {
  return (
        ...
        <footer className="bg-white shadow dark:bg-transparent relative bottom-0 w-screen">
            <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
                <div className="sm:flex sm:items-center sm:justify-between">
                    <p className='lg:block hidden font-bold text-sm sm:text-xl  flex-wrap sm:mx-10'>
                        <span className='text-slate-500 dark:text-slate-400'>Latracal</span>
                        <span className='text-slate-700 dark:text-slate-500'>Assignment</span>
                    </p>
                ...
                <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-300">© 2024 <span href="#" >Assignment</span>. All Rights Reserved.</span>
            </div>
        </footer>

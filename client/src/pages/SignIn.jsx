    ...
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <div className="flex flex-col gap-2 sm:gap-0 mt-5  mb-16 p-3.5 sm:mb-14.5 sm:p-0">
        <div className="flex flex-col ">
          ...
          <div className='flex flex-col text-yellow-600 dark:text-yellow-400 text-xs gap-1'>

          <p className='text-lg text-white'>Demo Credentials User: </p>
          <p>Email : test@gmail.com</p>
          <p>Password : 12345 </p>
          </div>
          <div className='flex flex-col text-yellow-600 dark:text-yellow-400 text-xs gap-1'>

          <p className='text-lg text-white'>Demo Credentials Admin : </p>
